...
COPY relay.js relays.js store.js push.js vapid-fleet.js vapid-fleet.json linked-devices.js binary-frame.js \
  ed25519.js notifications.js verification-code.js ./
